...
const annotationsTemporary = {
  'gene': {
    'Gene Description': "This gene encodes a chaperone for assembly of lysosomal vacuolar ATPase.[provided by RefSeq, Jul 2012]",
    ...
    'Rat - RGD': 'Predicted to be involved in vacuolar proton-transporting V-type ATPase complex assembly. Predicted to be located in lysosome. Predicted to be active in endoplasmic reticulum membrane. Human ortholog(s) of this gene implicated in X-linked myopathy with excessive autophagy. Orthologous to human VMA21 (vacuolar ATPase assembly factor VMA21); INTERACTS WITH 2,3,7,8-Tetrachlorodibenzofuran; 3-chloropropane-1,2-diol; bisphenol A."',
    'Mouse - Automated': 'Predicted to be involved in vacuolar proton-transporting V-type ATPase complex assembly. Predicted to be located in lysosome. Predicted to be active in endoplasmic reticulum membrane. Human ortholog(s) of this gene implicated in X-linked myopathy with excessive autophagy. Orthologous to human VMA21 (vacuolar ATPase assembly factor VMA21).',
    'Zebrafish - Automated': 'Predicted to be involved in vacuolar proton-transporting V-type ATPase complex assembly. Predicted to be located in ER to Golgi transport vesicle membrane; endoplasmic reticulum membrane; and endoplasmic reticulum-Golgi intermediate compartment membrane. Predicted to be integral component of membrane. Human ortholog(s) of this gene implicated in X-linked myopathy with excessive autophagy. Orthologous to human VMA21 (vacuolar ATPase assembly factor VMA21).',
    'C-Elegens - Automated': 'Predicted to be involved in vacuolar proton-transporting V-type ATPase complex assembly. Predicted to be located in cytoplasm. Predicted to be active in endoplasmic reticulum membrane. Human ortholog(s) of this gene implicated in X-linked myopathy with excessive autophagy. Orthologous to several human genes including VMA21 (vacuolar ATPase assembly factor VMA21).',
    'Druggability': {"target":{"name":"Vacuolar ATPase assembly integral membrane protein VMA21","tdl":"Tdark","fam":"Enzyme","sym":"VMA21","description":"This gene encodes a chaperone for assembly of lysosomal vacuolar ATPase.[provided by RefSeq, Jul 2012]","novelty":0.46129032}},
  },
  'variant': {
    'CADD': 33,
    'Phylop100': 6.373,
