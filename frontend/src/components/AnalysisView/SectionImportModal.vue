<template>
    <div class="modal-background">
      <div class="modal-container modal-file-import-container">
        ...
        <div class="content-item">
          ...
          <div class="tab-container">
            <div class="tab-buttons">
                <font-awesome-icon class="file-icon" :icon="['far', 'file']" size="lg"/>
            </div>
          </div>
          <form ref="modal">
...
export default {
  ...
  methods: {
    ...
    onAddFile() {
      this.$emit('add', this.fileUploaded);
    },
  },
};
</script>
