...
import {
  ...
  faUpRightFromSquare, faCirclePlus, faPencil, faEllipsisVertical, faLink} from '@fortawesome/free-solid-svg-icons';
...
library.add(
    ...
    faCirclePlus, faFile, faComment, faPencil, faEllipsisVertical, faLink);
