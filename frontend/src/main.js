...
import {
  ...
  faUpRightFromSquare, faCirclePlus, faPencil, faEllipsisVertical} from '@fortawesome/free-solid-svg-icons';
...
library.add(
    ...
    faCirclePlus, faFile, faComment, faPencil, faEllipsisVertical);
