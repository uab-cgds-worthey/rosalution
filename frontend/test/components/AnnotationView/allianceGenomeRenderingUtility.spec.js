...
describe('allianceGenomeRenderingUtility.js', () => {
  ...
  it.each([
    ...
    ['aliance genome 8.2.0>=', modelFixture['8.2.0>=,LMNA,fish'], true,
      'lmna<sup>bw25/bw25</sup>'],
    ['alliance genome 8.2.0>=', modelFixture['8.2.0>=,NUMB,mouse'], true,
      'Numb<sup>tm1Zili</sup>/Numb<sup>tm1Zili</sup> Numbl<sup>tm1Zili</sup>/Numbl<sup>tm1Zili</sup> ' +
