...
def test_remove_image_from_pedigree_section(analysis_collection, cpam0002_analysis_json):
...
def test_remove_section_supporting_evidence(analysis_collection, cpam0002_analysis_json):
